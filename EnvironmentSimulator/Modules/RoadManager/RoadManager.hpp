...
namespace roadmanager
{
	...
	*/
	...
	public:
		...
		*/
		ReturnCode MoveAlongS(double ds, double dLaneOffset, Junction::JunctionStrategyType strategy = Junction::JunctionStrategyType::STRAIGHT, bool actualDistance = true);
