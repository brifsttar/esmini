...
namespace esmini::common
{
    ...
    EsLogLevel TxtLogger::GetVerbosityLevelFromStr(const std::string& str)
    {
        if ("debug" == str)
        {
            return EsLogLevel::debug;
        }
        else if ("info" == str)
        {
            return EsLogLevel::info;
        }
        else if ("warn" == str)
        {
            return EsLogLevel::warn;
        }
        else if ("error" == str)
        {
            return EsLogLevel::error;
        }
        return EsLogLevel::info;  // by default we set INFO
    }
