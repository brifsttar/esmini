...
namespace esmini::common
{
    ...
    public:
        ...
        EsLogLevel GetVerbosityLevelFromStr(const std::string& str);
        ...
        template <class... ARGS>
        void
        Log(EsLogLevel msgLogLevel, const std::string& logStr, char const* function, char const* file, long line, const std::string& log, ARGS... args)
        {
    ...
    private:
        ...
        // log verbosity level
        EsLogLevel logLevel_ = EsLogLevel::info;
        // log file
...
{
    txtLogger.Log(EsLogLevel::debug, "debug", function, file, line, log, args...);
}

template <class... ARGS>
void __LOG_INFO__(char const* function, char const* file, long line, const std::string& log, ARGS... args)
{
    txtLogger.Log(EsLogLevel::info, "info", function, file, line, log, args...);
}

template <class... ARGS>
void __LOG_WARN__(char const* function, char const* file, long line, const std::string& log, ARGS... args)
{
    txtLogger.Log(EsLogLevel::warn, "warn", function, file, line, log, args...);
}
